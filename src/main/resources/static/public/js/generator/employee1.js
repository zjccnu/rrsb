$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '', name: 'empname', index: 'empName', width: 80 }, 			
			{ label: '', name: 'emptype', index: 'empType', width: 80 }, 			/*
		...
		/*	{ label: '', name: 'emptime', index: 'empTime', width: 80 }, 		*/	
			{ label: '', name: 'empexpiretime', index: 'empExpireTime', width: 80 }, 			
			/*{ label: '', name: 'empperformance', index: 'empPerformance', width: 80 }, 		*/	
			/*{ label: '', name: 'empsex', index: 'empSex', width: 80 }, 		*/	
			{ label: '', name: 'empphone', index: 'empPhone', width: 80 }, 			
			...
			{ label: '', name: 'empstate', index: 'empState', width: 80 }, 			
